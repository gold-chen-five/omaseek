...
export const FIXED_KEYS = [
  ...
  { label: 'Sessions (ask)', keys: 'L the next saved conversation, H the one before, both wrapping · 3L walks three · in the answer and in the field’s normal mode · the numbered squares under the status line do the same with a click' },
