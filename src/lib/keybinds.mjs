...
export const ACTIONS = [
  ...
  { id: 'stopAnswer', config: 'stop_answer_key', default: 'ctrl+q', scope: 'panel', command: 'stopAnswer',
    label: 'Stop answer', hint: 'ask: stop the reply being written, keeping the conversation and the words so far' },
