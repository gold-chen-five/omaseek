...
export const ACTIONS = [
  ...
  { id: 'translate', config: 'translate_key', default: 'gt', scope: 'reader', panes: ['answer', 'translation'], field: true, command: 'translate',
  ...
  { id: 'newSession', config: 'new_session_key', default: 'ctrl+c', scope: 'panel',
    label: 'New session', hint: 'ask: a new conversation, keeping this one in the ring · search: clear the results and the bar' },
  ...
  { id: 'closeSession', config: 'close_session_key', default: 'ctrl+x', scope: 'panel', command: 'closeSession',
    label: 'Close session', hint: 'closes what the keyboard is in: in ask, this conversation (showing the next); in the translation, that' },
  ...
  { id: 'keysHelp', config: 'keys_help_key', default: 'ctrl+k', scope: 'panel', command: 'keysHelp',
    label: 'Look up keys', hint: 'anywhere: every key in the panel, as a list to type into and filter — esc closes' },
  ...
  { id: 'handoff', config: 'handoff_key', default: 'ga', scope: 'reader', field: true, command: 'handOff',
    label: 'Hand off to agent', hint: 'the selected result’s URL, or the selection / reply under the cursor · field: the bar’s text, or the selection — as a draft' },
  { id: 'handoffAll', config: 'handoff_all_key', default: 'gA', scope: 'reader', field: true, command: 'handOffPage',
    label: 'Hand off everything', hint: 'every URL on the results page, or the whole conversation · field: that, with the bar’s text under it — as a draft' },
  { id: 'askNow', config: 'ask_now_key', default: 'gd', scope: 'reader', field: true, panes: ['results', 'answer', 'translation'], command: 'askNow',
    label: 'Ask about this', hint: 'results: the selected result · answer and translation: the selection, or the line under the cursor · field: the bar, or the selection — asked straight away' },
  { id: 'askAbout', config: 'ask_about_key', default: 'gj', scope: 'reader', field: true, panes: ['results', 'answer', 'translation'], command: 'askAbout',
